  ...
  <div class="container">
      ...
      <div class="menu-card">
        ...
        <div class="card-items">
          <div class="card-item" v-for="(item, index) in articlesItems" :key="index">
            <img :src="'http://localhost:3000/api/mc_article' + item.article_image" classe="article_image"
              alt="article image" />
    ...
    <div v-if="isAddingArticle" class="add-form">
      ...
      <form @submit.prevent="addItem">
        <input class="popup-input" type="text" v-model="newArticle.article_name" placeholder="Nom de l'article"
          required />
        <input class="popup-input" type="text" v-model="newArticle.article_type" placeholder="Type de l'article"
          required />
        <textarea class="textarea" v-model="newArticle.description" placeholder="Description" required></textarea>
        <input class="popup-input" type="number" v-model="newArticle.price" placeholder="Prix" required />
